...
def cpt_amulti_gclstm_param_parser():
    ...
    parser.add_argument('--Graph', default='Distance-line-Correlation')
    ...
    # version control
    parser.add_argument('--Group', default='Chongqing')
    parser.add_argument('--CodeVersion', default='TNT0')
    return parser
...
# deviceIDs = GPUtil.getAvailable(order='memory', maxLoad=0.5, maxMemory = 0.5, 
#                                 includeNan=False, excludeID=[], excludeUUID=[])

# args['Device'] = str(int(nni.get_sequence_id()) % 2)
