...
if __name__ == "__main__":
    ...
    os.system(shared_params_amulti_gclstm + ' --City Chicago --Group NYC --K 1 --L 1 --CodeVersion V0'
                                            ' --Graph Distance-Interaction-Correlation')

    os.system(shared_params_amulti_gclstm + ' --City DC --Group NYC --K 1 --L 1 --CodeVersion V0'
                                            ' --Graph Distance-Interaction-Correlation')