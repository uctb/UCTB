...
os.system("python GraphWaveNet_wrap.py --epochs 50 --dataset Bike --city Chicago --data_range 0.25 --train_data_length 91 --MergeIndex 3 --MergeWay sum --gcn_bool --adjtype doubletransition --addaptadj  --randomadj")
