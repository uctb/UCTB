...
if __name__ == "__main__":
    ...
    os.system(shared_params_amulti_gclstm + ' --T 6 --City NYC --Graph Distance --K 1 --L 1 --CodeVersion T6')
    os.system(shared_params_amulti_gclstm + ' --T 6 --City NYC --Graph Interaction --K 1 --L 1 --CodeVersion T6')
    os.system(shared_params_amulti_gclstm + ' --T 6 --City NYC --Graph Correlation --K 1 --L 1 --CodeVersion T6')

    os.system(shared_params_amulti_gclstm + ' --T 6 --City DC --Graph Distance --K 1 --L 1 --CodeVersion T6')
    os.system(shared_params_amulti_gclstm + ' --T 6 --City DC --Graph Interaction --K 1 --L 1 --CodeVersion T6')
    os.system(shared_params_amulti_gclstm + ' --T 6 --City DC --Graph Correlation --K 1 --L 1 --CodeVersion T6')

    os.system(shared_params_amulti_gclstm + ' --T 6 --City Chicago --Graph Distance --K 1 --L 1 --CodeVersion T6')
    os.system(shared_params_amulti_gclstm + ' --T 6 --City Chicago --Graph Interaction --K 1 --L 1 --CodeVersion T6')
    os.system(shared_params_amulti_gclstm + ' --T 6 --City Chicago --Graph Correlation --K 1 --L 1 --CodeVersion T6')
