...
class GraphGenerator():
    ...
    def build_graph(self, graph_name):
        ...
        if graph_name.lower() == 'distance':
            ...
            AM = distance_adjacent(lat_lng_list[self.traffic_data_index],
