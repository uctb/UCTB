...
class AMulti_GCLSTM_V1(BaseModel):
    def __init__(self,
                 num_node,
                 num_graph,
                 external_dim,
        ...
        super(AMulti_GCLSTM_V1, self).__init__(code_version=code_version, model_dir=model_dir, GPU_DEVICE=GPU_DEVICE)
    ...
    def build(self):
        ...
        super(AMulti_GCLSTM_V1, self).build()
