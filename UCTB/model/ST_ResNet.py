    ...
    def build(self):
        with self._graph.as_default():
            ...
            if self._closeness_len is not None and self._closeness_len > 0:
                ...
                self._input['closeness_len'] = c_conf.name
            ...
            if self._period_len is not None and self._period_len > 0:
                ...
                self._input['period_len'] = p_conf.name
            ...
            if self._trend_len is not None and self._trend_len > 0:
                ...
                self._input['trend_len'] = t_conf.name
            ...
            for conf in target_conf:
                ...
                residual_input = tf.layers.conv2d(conf, filters=self._conv_filters, kernel_size=[3, 3],
